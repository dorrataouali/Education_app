...
import 'package:school_app/Screens/side_bar/side_bar.dart';
...
class _CleaningPageState extends State<CleaningPage> {
  // Rooms to clean
  List<dynamic> _rooms =[
    ['Languages', 'https://img.icons8.com/officel/2x/living-room.png', Colors.red, 0],
    ['Coding', 'https://img.icons8.com/fluency/2x/bedroom.png', Colors.orange, 1],
    ['Physics', 'https://img.icons8.com/color/2x/bath.png', Colors.blue, 1],
    ['Chimics', 'https://img.icons8.com/dusk/2x/kitchen.png', Colors.purple, 0],
    ['Design', 'https://img.icons8.com/color/2x/office.png', Colors.green, 0]
