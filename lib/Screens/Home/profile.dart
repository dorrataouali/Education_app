...
import 'package:school_app/widgets/FadeAnimation.dart';
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 20,),
                    FadeAnimation(1.3, Text("John Doe", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22),)),
                    SizedBox(height: 10,),
                            ...
                            children: [
                              FadeAnimation(1.2, Column(
                                children: [
                                  ...
                                  SizedBox(height: 5,),
                                  Text("10 courses", style: TextStyle(color: Colors.grey,),),
                                ],
                              )),
                              FadeAnimation(1.5, Column(
                                children: [
                                  Text("DOING", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                                  SizedBox(height: 5,),
                                  Text("5 courses", style: TextStyle(color: Colors.grey,),),
                                ],
                              )),
                              FadeAnimation(1.6, Column(
                                children: [
                                  Text("DONE", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                                  SizedBox(height: 5,),
                                  Text("6 courses", style: TextStyle(color: Colors.grey,),),
                                ],
                              )),
                            ]
                        )
